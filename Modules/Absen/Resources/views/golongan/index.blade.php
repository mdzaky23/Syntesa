...
<div class="col-lg-12 col-12">
  <div class="card card-company-table">
    <div class="card-body p-0">
      <div class="card-body">
        <h2 class="fw-bolder mb-4">Data Golongan</h2>
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">      
        ...
        <a href="/absen/golongan/tambah"><button class="btn btn-primary" type="button">+ Tambah Data</button></a>
          <thead>
            <tr>
              <th></th>
              <th></th>
          ...
          @foreach($golongans as $golongan)
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center">
                  <div>
                    <a href="/absen/golongan/{{ $golongan->id }}/edit" type="button" class="btn btn-icon btn-warning">
                      <span data-feather="edit"></span>
                    </a>

                      <form action="{{ url('absen/golongan', $golongan->id) }}" method="POST" class="d-inline">
                        @method('delete')
                        @csrf
