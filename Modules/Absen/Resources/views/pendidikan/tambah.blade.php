            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Tambah Data pendidikan</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Tambah Data pendidikan
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row match-height">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card card-payment">
                            <div class="card-body">
                                <form action="/absen/pendidikan" class="form" method="post">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="nama_pendidikan" name="nama_pendidikan"class="form-control"
                                                    placeholder="Input Nama Pendidikan" />
                                            </div>
                                        </div>
