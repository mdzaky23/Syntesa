          ...
          @foreach($uangsakus as $uangsaku)
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center">
                  <div>
                  <a href="/absen/uangsaku/{{ $uangsaku->id }}/edit" type="button" class="btn btn-icon btn-warning">
                      <span data-feather="edit"></span>
                    </a>

                      <form action="{{ url('absen/uangsaku', $uangsaku->id) }}" method="POST" class="d-inline">
                        @method('delete')
                        @csrf
