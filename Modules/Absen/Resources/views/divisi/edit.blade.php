            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Edit Data divisi</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/absen">Home</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="/absen/divisi">Data divisi</a>
                                    </li>
                                    <li class="breadcrumb-item active">Edit Data divisi
                                    </li>
                                </ol>
                            </div>
                        </div>
...
<div class="col-12 order-0 order-md-1">
      ...
      <ul class="nav nav-pills mb-2">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="/absen/divisi">
                ...
                <div class="row match-height">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card card-payment">
                            <div class="card-body">
                                <form action="{{ url('absen/divisi', $divisi->id) }}" class="form" method="post">
                                    @csrf
                                    @method('put')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-2">
                                                <label class="form-label" for="nama_divisi">Nama Jabatan</label>
                                                <input type="text" class="form-control" id="nama_divisi"  
                                                    placeholder="Input nama divisi" name="nama_divisi" value="{{ $divisi->nama_divisi }}"/>
                                            </div>
                                        </div>

                                        <div class="col-12">
                                            <div class="d-grid col-12">
                                                <button type="submit" class="btn btn-primary">Edit Divisi</button>
                                            </div>
                                        </div>
                                </form>
                            </div>
