...
<div class="col-lg-12 col-12">
  <div class="card card-company-table">
    <div class="card-body p-0">
      <div class="card-body">
        <h2 class="fw-bolder mb-4">Data Jabatan</h2>
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">      
        ...
        <a href="/absen/jabatan/tambah"><button class="btn btn-primary" type="button">+ Tambah Data</button></a>
          <thead>
            <tr>
              <th></th>
              <th></th>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center">
                  <div>
                    <div class="fw-bolder">{{ $jabatan->nama_jabatan }}</div>
                  </div>
                </div>
              </td>
              ...
              <td>
                <div class="d-flex align-items-center">
                  <div>
                      <a href="/absen/jabatan/{{ $jabatan->id }}/edit" type="button" class="btn btn-icon btn-warning">
                        <span data-feather="edit"></span>
                      </a>

                      <form action="{{ url('absen/jabatan', $jabatan->id) }}" method="POST" class="d-inline">
                        @method('delete')
                        @csrf
