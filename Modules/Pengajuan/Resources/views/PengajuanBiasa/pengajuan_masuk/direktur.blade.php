                                    ...
                                    <tbody>
                                      ...
                                      $status = Modules\Pengajuan\Entities\StatusPengajuan::select()
                                       ...
                                       @endphp
                                        ...
                                        @if ($histori->status==1 && $kategori->kategori==1 && $jabatan->jabatan==2 ||  $histori->status==1 && $kategori->kategori==1 && $jabatan->jabatan==5 || $histori->status==1 && $kategori->kategori==1 && $jabatan->jabatan==8   )
