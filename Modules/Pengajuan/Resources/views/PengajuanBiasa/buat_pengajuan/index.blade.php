            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Buat Pengajuan Biasa</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Pengajuan Biasa</a>
                                    </li>
                                    <li class="breadcrumb-item active"><a href="#">Buat Pengajuan Biasa </a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            <select class="form-select" id="kategori" name="kategori"
                                                ...
                                                <option value="1">Lebih dari 1 Juta</option>
                                                <option value="2">Kurang dari 1 Juta
                                                </option>
                                            </select>
                                        ...
                                        <div class="mb-1 col-md-12 position-relative" >
                                            <label class="form-label" for="tanggal">Tanggal</label>
                                            <input type="date" id="tanggal" name="tanggal" class="form-control pickadate"
