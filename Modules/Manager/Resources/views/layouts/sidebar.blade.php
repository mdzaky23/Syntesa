        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="/pengajuan/lihatpengajuanstaf"><i
                            data-feather="grid"></i><span class="menu-title text-truncate" data-i18n="surat">Pengajuan
                            Biasa</span></a>
                    <ul class="menu-content">
                        <li class=" nav-item"><a class="d-flex align-items-center" href="/pengajuan/pengajuan_masukM"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="pmasuk">Pengajuan
                                    Masuk</span></a>
                        </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="/pengajuan/lihatpengajuanstaf"><i
                            ...
                            data-i18n="surat">Pengajuan Dinas</span></a>
                    <ul class="menu-content">
                        <li class=" nav-item"><a class="d-flex align-items-center"
                                href="/pengajuan/pengajuan_masukM"><i data-feather="circle"></i><span
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="/pengajuan/lihatpengajuanstaf"><i
                            data-feather="grid"></i><span class="menu-title text-truncate"
                            data-i18n="surat">Pengajuan Projek</span></a>
                    <ul class="menu-content">
                        <li class=" nav-item"><a class="d-flex align-items-center"
                                href="/pengajuan/pengajuan_masukM"><i data-feather="circle"></i><span
                                    class="menu-item text-truncate" data-i18n="pmasuk">Pengajuan
