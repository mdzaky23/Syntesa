                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Edit Surat Edaran
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row match-height">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card card-payment">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ url('surat/printedaran', $suratedaran->id) }}"
                                    class="form">
                                    @csrf
                                    @method('put')
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="no_suratedaran" class="form-control"
                                                    ...
                                                    value="{{ $suratedaran->no_suratedaran }}" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="tentang" class="form-control"
                                                    ...
                                                    name="tentang" value="{{ $suratedaran->tentang }}" />
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-12">
                                                    <div id="full-wrapper">
                                                        <div id="full-container">
                                                            <textarea id="isi" class="form-control" placeholder="Isi surat" name="isi">{{ $suratedaran->isi }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12 position-relative">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="tgl_suratedaran"
                                                    ...
                                                    name="tgl_suratedaran" value="{{ $suratedaran->tgl_suratedaran }}" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-2">
