            ...
            <div class="content-header row">
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Data Surat Perjalanan Dinas</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Surat Perjalanan Dinas
                                    </li>
                                </ol>
                            </div>
                        </div>
                                        ...
                                        @if (!empty($suratperdins))
                                            @foreach ($suratperdins as $suratperdin)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>{{ $suratperdin->perihal }}</center>
                                                    </td>
                                                    <td>
                                                        <center>{{ $suratperdin->instansi }}</center>
                                                    </td>
                                                    <td>
                                                        <center>{{ $suratperdin->keterangan }}</center>
                                                    </td>
                                                    <td>
                                                        <center>
                                                            @if ($suratperdin->dokumen)
                                                                <div class="btn-group dropup d-block">
                                                                    <a href="{{ asset('storage/' . $suratperdin->dokumen) }}"
                                                                        target="blank"
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item"
                                                                            href="{{ url('surat/printperdin/' . $suratperdin->id . '/edit') }}">Edit
                                                                            Isi Surat</a>
                                                                        <a class="dropdown-item"
                                                                            href="{{ url('surat/suratperdin/' . $suratperdin->id . '/edit') }}">Edit
                                                                            Arsip Surat</a>
                                                                    </div>
                                                                </div>
                                                            @else
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    <form id="editUserForm" class="row gy-1 pt-75" method="POST" action="/surat/suratperdin"
                        enctype="multipart/form-data" onsubmit="myFunction()">
                        @csrf
                        <div class="col-12 col-md-6">
                            <label class="form-label" for="no_suratperdin">No Surat</label>
                            <input type="text" id="no_suratperdin" name="no_suratperdin" class="form-control "
                                placeholder="No Surat" value="" data-msg="Please enter your first name" />
                        </div>
                        <div class="col-12 col-md-6 position-relative">
                            <label class="form-label" for="tgl_suratperdin">Tanggal Surat</label>
