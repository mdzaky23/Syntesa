                ...
                <div class="row match-height">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card card-payment">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ url('surat/printsurat', $suratkeluar->id) }}"
                                        ...
                                        <div class="col-12 position-relative">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="tanggal_buat" class="form-control flatpickr-basic"
                                                    name="tanggal_buat" value="{{ $suratkeluar->tanggal_buat }}" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-2">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="lampiran" class="form-control"
                                                    placeholder="1 (satu) berkas" name="lampiran"
                                                    value="{{ $suratkeluar->lampiran }}" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-2">
                                                ...
                                                <div class="col-12">
                                                    <div id="full-wrapper">
                                                        <div id="full-container">
                                                            <textarea id="isi" class="form-control-lg" placeholder="Dengan Hormat..." name="isi" value="">{{ $suratkeluar->isi }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="card mb-2">
                                                ...
                                                <div class="col-12">
                                                    <div id="full-wrapper">
                                                        <div id="full-container">
                                                            <textarea rows="6" id="tembusan" class="form-control" placeholder="Input Tembusan" name="tembusan"
                                                                value="">{{ $suratkeluar->tembusan }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
