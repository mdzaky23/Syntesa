                    ...
                    <div class="row match-height">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="card card-payment">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('pengajuan.update', $project->id) }}" method="POST"
                                            ...
                                            <div class="col-xl-2 col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" id="no_project" value="22.1" name="no_project"
                                                        required value="{{ old('no_project', $project->no_project) }}"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                            <!-- full Editor start -->
                                            ...
                                            <div class="col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="nama_project" name="nama_project" required
                                                ...
                                                <div class="col-xl-2 col-md-6 col-12">
                                                    <div class="mb-2">
                                                        ...
                                                        <input type="text" id="tgl_project"
                                                            class="form-control flatpickr-basic" name="tgl_project" required
                                                            value="{{ old('tgl_project', $project->tgl_project) }}"
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    @if (!empty($project->sales_order))
                                                        <label for="sales_order" class="form-label"><a target="_blank"
                                                                href="{{ asset('storage/' . str_replace('public/', '', $project->sales_order)) }}">Sales
                                                                Order</a></label>
                                                    @else
                                                        <label for="sales_order" class="form-label"><a target="_blank"
                                                                href="#">Sales Order</a></label>
                                                    @endif

                                                    <input type="file" id="sales_order" class="form-control"
                                                        name="sales_order" value="{{ $project->sales_order }}" />
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <textarea name="deskripsi" id="deskripsi" rows="3" placeholder="Deskripsi"
                                                                        class="form-control @error('deskripsi') is-invalid @enderror"> {{ old('deskripsi', $project->deskripsi) }}</textarea>
                                                                    @error('deskripsi')
                                                                            ...
                                                                            <div class="input_add">
                                                                                <div class="row d-flex align-items-end">
                                                                                    <div class="col-xl-2 col-md-6 col-12">
                                                                                        <div class="mb-1">
                                                                                            ...
                                                                                            <select class="form-control"
                                                                                                ...
                                                                                                style="font-size: 14px;">
                                                                                                <option
                                                                                                    @if ($b->kategori == 'Tiket') selected @endif
                                                                                                    value="Tiket">Tiket
                                                                                                </option>
                                                                                                <option
                                                                                                    @if ($b->kategori == 'Hotel') selected @endif
                                                                                                    value="Hotel">Hotel
                                                                                                </option>
                                                                                                <option
                                                                                                    @if ($b->kategori == 'Transport') selected @endif
                                                                                    ...
                                                                                    <div class="col-xl-1 col-md-6 col-12">
                                                                                        <div class="mb-1">
                                                                                            <button
                                                                                                class="remove_btn btn btn-outline-danger text-nowrap px-1 waves-effect"
                                                                                                type="button">
                                                                                    ...
                                                                                    <div class="col-xl-2 col-md-6 col-12">
                                                                                        <div class="mb-1">
                                                                                            ...
                                                                                            <select class="form-control"
                                                                                                ...
                                                                                                style="font-size: 14px;">
                                                                                                <option
                                                                                                    @if ($p->kategori == 'Tiket') selected @endif
                                                                                                    value="Tiket">Tiket
                                                                                                </option>
                                                                                                <option
                                                                                                    @if ($p->kategori == 'Hotel') selected @endif
                                                                                                    value="Hotel">Hotel
                                                                                                </option>
                                                                                                <option
                                                                                                    @if ($p->kategori == 'Transport') selected @endif
                                                                                                    value="Transport">Transport
                                                                                                </option>
                                                                            ...
                                                                            <div class="input_add">
                                                                                <div class="row d-flex align-items-end">
                                                                                    ...
                                                                                    <div class="col-xl-4 col-md-6 col-12">
                                                                                        <div class="mb-1">
                                                                                            <label class="form-label"
                                                                                                for="dokumen_lampiran">Lampiran
                                                                                                : </label>
                                                                                            @if (!empty($b->dokumen))
                                                                                                <label><a
                                                                                                        href="/project/lampiran/{{ $b->id }}"
                                                                                                        target="_blank">Klik</a></label>
                                                                                            @else
                                                                                                <label><a href="#"
                                                                                                        target="_blank">Klik</a></label>
                                                                                            @endif
                                                                                            <input class="form-control"
                                                                                                name="dokumen_lampiran_{{ $b->kategori }}[]"
                                                                                                type="file" multiple>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-xl-4 col-md-6 col-12">
