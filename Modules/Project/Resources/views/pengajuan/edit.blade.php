                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-2 col-md-6 col-12">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="no_project" value="22.1" name="no_project" required autofocus value="{{ old('no_project', $project->no_project) }}"
                                                    class="form-control" />
                                            </div>
                                        </div>
                                        <!-- full Editor start -->
                                        <div class="mb-1">
                                            ...
                                            <select class="form-select" id="pemegang_project" name="pemegang_project" required autofocus value="{{ old('pemegang_project') }}">
                                                <option value="Marcella">Marcella</option>
                                                    <option value="Stevany">Stevany</option>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" class="form-control @error('nama_project') is-invalid @enderror" id="nama_project" name="nama_project" 
                                                     required autofocus value="{{ old('nama_project', $project->nama_project) }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xl-2 col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" id="tgl_project"
                                                        class="form-control flatpickr-basic" name="tgl_project" required autofocus value="{{ old('tgl_project', $project->tgl_project) }}"
