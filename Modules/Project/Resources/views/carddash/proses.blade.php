                                        ...
                                        @if (!empty($diproses))
                                            @foreach ($diproses as $proses)
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td>{{ $proses->no_project }}</td>
                                                    <td>{{ $proses->pemegang_project }}</td>
                                                    <td>{{ $proses->tgl_project }}</td>
                                                    <td>{{ $proses->nama_project }}</td>
                                                    <td>{{ $proses->deskripsi }}</td>
                                                    <td>{{ $proses->pendapatan }}</td>
                                                    <td>{{ $proses->laba }}</td>
                                                    <td>{{ $proses->presentase }}</td>

                                                    <td>
                                                        <a class="btn btn-icon btn-primary"><span
                                                                data-feather="trash-2"></span></a>
                                                        <a class="btn btn-icon btn-primary"><span
                                                                data-feather="upload"></span></a>
