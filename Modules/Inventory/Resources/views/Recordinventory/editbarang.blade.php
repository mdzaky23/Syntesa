      ...
      <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
          <div class="row breadcrumbs-top">
            <div class="col-12">
              <h2 class="content-header-title float-start mb-0">Edit Barang</h2>
              <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item">Record Inventory</a>
                  </li>
                  <li class="breadcrumb-item">Edit Barang</a>
                  </li>
                </ol>
              </div>
            </div>
                ...
                <div id="personal-info-vertical-modern" class="content" role="tabpanel" aria-labelledby="personal-info-vertical-modern-trigger">
                  ...
                  <div class="row">
                    <div class="mb-1 col-md-6">
                      ...
                      <input type="text" id="nama_brg" class="form-control" name="nama_brg" placeholder=" Masukan Nama Barang" value="{{$barang->nama_brg}}" />
                    </div>
                    <div class="mb-1 col-md-6">
                      <label class="form-label" for="jumlah_brg">Jumlah barang</label>
                      <input type="string" id="jumlah_brg" class="form-control" name="jumlah_brg" placeholder=" Masukan Jumlah barang" value="{{$barang->jumlah_brg}}" />
                    </div>
                    <div class="mb-1 col-md-6">
                      <label class="form-label" for="merk_brg">Merk Barang</label>
                      <input type="text" id="merk_brg" class="form-control" name="merk_brg" placeholder=" Masukan Merk Barang" value="{{$barang->merk_brg}}" />
                    </div>
                    <div class="mb-1 col-md-6">
                      <label class="form-label" for="tipe_brg">Tipe Barang</label>
                      <input type="text" id="tipe_brg" class="form-control" name="tipe_brg" placeholder=" Masukan Tipe Barang" value="{{$barang->tipe_brg}}" />
                    </div>
                    <div class="mb-1 col-md-6">
